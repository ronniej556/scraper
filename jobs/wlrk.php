...
foreach ($q as $row) {
    ...
    $pData['phone'] = $html->find('.attorney--meta-phone', 0)->plaintext;
    ...
    $education = array();
    foreach($html->find('.attorney--education') as $item)
    {
    ...
    $values['description'] = $html->find('.attorney--biography', 0)->plaintext;
