...
$firm_name = 'Sherman & Howard L.L.C';
...
foreach ($q as $row) {
    ...
    $education = array();
    foreach($html->find('.academic-info.education') as $item)
    {
    ...
    foreach($html->find('.academic-info') as $item)
    {
    ...
    foreach($html->find('.areas-ephasis-list') as $item)
    {
    ...
    $values['description'] = $html->find('.profile-details .col-md-8', 0)->plaintext;
