...
$spider_name = 'jmbm';
$firm_name = 'Jeffer Mangels Butler & Mitchell LLP';
...
foreach ($q as $row) {
    ...
    $education = array();
    foreach($html->find('#education p') as $item)
    {
    ...
    foreach($html->find('#baradmissions') as $item)
    {
    ...
    foreach($html->find('#banner-services') as $item)
    {
    ...
    $values['description'] = $html->find('.description', 2)->plaintext;
